...
import { FilePlus, List, Shield, CheckCircle2 } from 'lucide-react';
...
export default function TrustRegistry() {
  const anchors = [
    ...
    { name: 'Red Cross', did: 'did:web:icrc.refugee-id.org', keys: 'Ed25519', status: 'Active', synced: '1 day ago' },
  ];
  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-2">Verified issuers within the RefugeeID ecosystem.</p>
      </div>
          ...
          <Card key={anchor.did} className="border-slate-200 shadow-sm">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                  <span className="block text-slate-500 mb-1">DID (Decentralized Identifier)</span>
